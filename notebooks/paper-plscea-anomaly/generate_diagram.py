...
OUT = "../../posts/series/papers/images/plscea-eli5-sketch.png"

with plt.xkcd():
    fig, ax = plt.subplots(figsize=(12, 5))
    ax.set_xlim(0, 12); ax.set_ylim(0, 5); ax.axis("off")
    boxes = [
        (0.3, 1.8, 2.7, "Frozen ViT's\nattention: built for\n\"what object is this\""),
        (3.3, 1.8, 2.9, "Re-weigh by how much\npatches agree with\neach other (no new\nweights!)"),
        (6.5, 1.8, 2.8, "Odd-one-out patches\nstand out more"),
        (9.6, 1.8, 2.0, "Scratch\nfound"),
    ]
    patches = []
    for x, y, w, label in boxes:
        ...
        box = FancyBboxPatch((x, y), w, h, boxstyle="round,pad=0.1", linewidth=2,
                              edgecolor="black", facecolor="#f0e6ff")
        ax.add_patch(box)
    ...
    fig.text(0.5, 0.95, "PL-SCEA: repurposing frozen attention for anomaly spotting",
