...
![overfitting](validation_and_overfitting_images/overfitting_and_underfitting.png)

- Another useful way to understand overfitting and underfitting is to use following figure.

![overfitting](validation_and_overfitting_images/model_complexity.png)
...
1. If this is not the case then there is something which is wrong.
   ...
   b. Train and test are from differnt distribution. (here train test means train and production)
      ...
      ![Train and test distribution difference](validation_and_overfitting_images/train_test_different_distribution.png)
    ...
    - __Solution__:
      ...
      ![leaderboard_problem](validation_and_overfitting_images/leader_board_problem.png)
      ...
      ![minimize_difference](validation_and_overfitting_images/minimize_difference_in_train_test.png)
