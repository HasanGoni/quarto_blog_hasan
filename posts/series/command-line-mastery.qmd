...
8. [**Environment Mastery**](command-line-mastery/08-environment-mastery.qmd) - Customizing your shell environment and variables
9. [**HPC Job Scheduling with bsub**](command-line-mastery/09-hpc-job-scheduling.qmd) - Mastering cluster job submission
10. [**Parallel Processing Power**](command-line-mastery/10-parallel-processing.qmd) - GNU parallel and advanced techniques
...
12. [**Automation Excellence**](command-line-mastery/12-automation-excellence.qmd) - Error handling, logging, and robust scripts
