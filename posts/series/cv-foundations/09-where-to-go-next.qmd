...
courses = {
    ...
    "Paid": [
        "Complete Computer Vision Bootcamp (Udemy)",
...
:::{.callout-note}
## Series Navigation
- **Previous**: [Your First CV Project: Putting It All Together](../08-first-cv-project/)
- **Series Home**: [Computer Vision Foundations](../computer-vision-foundations.qmd)
- **Start Over**: [Why Computer Vision?](../01-why-computer-vision/)
:::
